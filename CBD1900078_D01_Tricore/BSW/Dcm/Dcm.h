 ...
 *  10.04.01  2018-11-13  visygr  ESCAN00101202 Service 0x2A: Overwritten RAM behind a DCM buffer when using UUDT delay timer
 *                        visygr  STORYC-6991   Cover or justify all runtime checks
 *  10.04.02  2019-03-29  visvkr  ESCAN00100995 ECU returns NRC 0x7F instead of NRC 0x11 for services that are not configured in all connections
 *                        visaey  ESCAN00102499 ECU does not send response after jump from FBL
 *********************************************************************************************************************/
#if !defined(DCM_H)
# define DCM_H
/* ----------------------------------------------
...
# define DIAG_ASR4DCM_RELEASE_VERSION                                0x02u
...
# define DCM_SW_PATCH_VERSION                                        2u
