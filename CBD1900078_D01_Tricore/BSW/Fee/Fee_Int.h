...
# define FEE_INTERNAL_MINOR_VERSION                                   (4u)
# define FEE_INTERNAL_PATCH_VERSION                                   (0u)
...
struct Fee_InstanceCopyContextStruct /*<! Context, i.e. parameters and run-time variables, of an instance copy operation */
{
    ...
    Fee_Bool sourceWrittenWithOldLayout; /*<! Determines whether source chunk is written with old or with new layout (ceiled) */
...
{
    uint32 sectorHeader_au32[FEE_INTERNAL_BUFFER_SIZE / 4u];
