...
STATIC CONST(IpV6_AddrType, IPV6_CONST) IpV6_Mld_ReportDstAddr =
{
  {
  ...
  boolean                 Include)
{
  ...
  while (0 < SrcAddrCount)
  {
    ...
    IPV6_ADDR_COPY(IPV6_CTRL_VAR(IpV6_Mld_McSrcAddrData)[McSrcAddrIdx], SrcAddrsPtr[SrcAddrCount]); 
  }
  ...
  boolean                        NewIfStateModeIsInclude)
{
  ...
  if (NewIfStateModeIsInclude != IfStatePtr->ModeIsInclude)
  {
    ...
    while (IPV6_DLIST_END_IDX != NewIfStateSrcListPtr->FirstIdx)
    {
      ...
      IPV6_ADDR_COPY(IPV6_CTRL_VAR(IpV6_Mld_IfStateSrcAddrData)[NewIdx].SrcAddr, IPV6_CTRL_VAR(IpV6_Mld_McSrcAddrData)[NewIfStateSrcListPtr->FirstIdx]); 
  ...
  boolean                 ModeIsInclude)
{
  ...
  if (IPV6_DLIST_END_IDX == McAddrIdx)
  {
    ...
    IPV6_ADDR_COPY(IPV6_CTRL_VAR(IpV6_Mld_McAddrData)[McAddrIdx].McAddr, *McAddrPtr); 
  ...
  uint32                        RespDelayMs)
{
  ...
  if (FALSE == McAddrPtr->PR)
  {
    ...
    while (0 < SrcAddrCount)
    {
      ...
      IPV6_ADDR_COPY(IPV6_CTRL_VAR(IpV6_Mld_McSrcAddrData)[SrcAddrIdx], SrcAddrListPtr[SrcAddrCount]); 
    }
  ...
  else
  {
    ...
    if (IPV6_TIME_IS_LOWER(NewReportTimeout, McAddrPtr->PRTimeout) == TRUE)
    {
  ...
  uint32                        MaxResDelayMs)
{
  ...
  else if (IPV6_TIME_IS_LOWER(ResTimeout, McAddrEntryPtr->PRTimeout) == TRUE)
  {
    McAddrEntryPtr->PRTimeout = ResTimeout;
  }
  else
  ...
  IPV6_P2C(uint8) DataPtr)
{
  ...
  QueryHdrPtr = (IPV6_P2C(IpV6_Mld_V1QueryHeaderType))DataPtr; 

  MaxResDelayMs = TCPIP_NTOHS(QueryHdrPtr->MaxResDelayNbo);
  ...
  uint16                 IpPayloadLen)
{
  ...
  QueryHdrPtr = (IPV6_P2C(IpV6_Mld_QueryHeaderType))&IpPayloadPtr[IcmpPayloadOfs]; 

  MaxRespDelayMs = TCPIP_NTOHS(QueryHdrPtr->MaxResCodeNbo);
  ...
  SrcAddrCount = TCPIP_NTOHS(QueryHdrPtr->NumberOfSourcesNbo);
  ...
  if ((0 < IPV6_MLD_VAR(ReportPendingCount)) && (IPV6_TIME_IS_LOWER(IPV6_MLD_VAR(ReportTimeout), NewReportTimeout) == TRUE))
  {
  ...
  else
  {
    ...
    if (IPV6_DLIST_END_IDX != McAddrIdx)
    {
      ...
      IpV6_Mld_VScheduleAddrQuery(IpCtrlIdx, &IPV6_CTRL_VAR(IpV6_Mld_McAddrData)[McAddrIdx], (IPV6_P2C(IpV6_AddrType))&IpPayloadPtr[IcmpPayloadOfs + sizeof(IpV6_Mld_QueryHeaderType)], (uint8)SrcAddrCount, ResDelayMs); 
    }
  }
  ...
  IPV6_P2V(boolean)        ModeIsIncludePtr)
{
    ...
    if (FALSE == IPV6_CTRL_VAR(IpV6_Mld_McMsData)[McMsIdx].ModeIsInclude)
    {
      ...
      if (1 == ExcludeEntryCount)
      {
        ...
        while (IPV6_DLIST_END_IDX != McSrcAddrIdx)
        {
          ...
          IPV6_ADDR_COPY(IPV6_CTRL_VAR(IpV6_Mld_McSrcAddrData)[NewIdx], IPV6_CTRL_VAR(IpV6_Mld_McSrcAddrData)[McSrcAddrIdx]); 
  ...
  if (0 < ExcludeEntryCount)
  {
    ...
    /* ListPtr not contains intersection of all EXCLUDE entries.
  ...
  uint16                        BufLen)
{
  ...
  RecordHdrPtr = (IPV6_P2V(IpV6_Mld_ReportRecordHeaderType))&BufPtr[BufPosTmp]; 
  IPV6_ADDR_COPY(RecordHdrPtr->McAddr, McAddrPtr->McAddr); 
  ...
  IPV6_P2V(IpV6_Mld_McAddrType) McAddrPtr)
{
  ...
  ReportHdrPtr = (IPV6_P2V(IpV6_Mld_ReportHeaderType))&MldBufPtr[0]; 
  ...
  uint8                    IpCtrlIdx)
{
  ...
  while (IPV6_DLIST_END_IDX != McAddrIdx)
  {
    ...
    ReportHdrPtr->McAddrRecCountNbo = TCPIP_HTONS(RecordCount);
  ...
  IPV6_P2V(uint8)          SrcAddrCount)
{
  ...
  while(IPV6_DLIST_END_IDX != SrcAddrIdx)
  {
    ...
    if (IPV6_DLIST_END_IDX != Idx)
    {
      ...
      IPV6_ADDR_COPY(BufPtr[*BufPos], IPV6_CTRL_VAR(IpV6_Mld_IfStateSrcAddrData)[SrcAddrIdx].SrcAddr); 
  ...
  IPV6_P2V(uint8)          SrcAddrCount)
{
  ...
  while(IPV6_DLIST_END_IDX != SrcAddrIdx)
  {
    ...
    IPV6_ADDR_COPY(BufPtr[*BufPos], IPV6_CTRL_VAR(IpV6_Mld_McSrcAddrData)[SrcAddrIdx]); 
    (*BufPos) += sizeof(IpV6_AddrType);
  ...
  IPV6_P2C(IpV6_Mld_McAddrType) McAddrPtr)
{
  ...
  ReportHdrPtr = (IPV6_P2V(IpV6_Mld_ReportHeaderType))MldBufPtr; 
  ReportHdrPtr->Reserved16Nbo = 0;
  ReportHdrPtr->McAddrRecCountNbo = IPV6_UINT8_HTONS(1);
  ...
  RecordHdrPtr = (IPV6_P2V(IpV6_Mld_ReportRecordHeaderType))&MldBufPtr[DataPos]; 

  RecordHdrPtr->Type       = (uint8)((TRUE == McAddrPtr->IfState.ModeIsInclude) ? IPV6_MLD_RECORD_TYPE_TO_IN : IPV6_MLD_RECORD_TYPE_TO_EX);
  RecordHdrPtr->AuxDataLen = 0;

  IPV6_ADDR_COPY(RecordHdrPtr->McAddr, *McAddrPtr); 
  ...
  boolean                 AllowUnspecSrcAddr)
{
  ...
  IcmpHdrPtr = (IPV6_P2V(IpV6_IcmpHeaderType))&IPV6_MLD_VAR(TxBufPtr)[8]; 

  IcmpHdrPtr->Type = Type;
  IcmpHdrPtr->Code = IPV6_MLD_ICMP_MSG_CODE;
  IcmpHdrPtr->ChecksumNbo = TCPIP_CHECKSUM_UNSET; /* set to 0 for calculation. Has to be updated before IpV6_Transmit() */
  ...
  IPV6_P2C(IpV6_Mld_McAddrType) McAddrPtr)
{
  ...
  {
    RecordHdrPtr = (IPV6_P2V(IpV6_Mld_ReportRecordHeaderType))&MldBufPtr[MldBufPos]; 
...
#endif  /* (TCPIP_SUPPORT_MLD == STD_ON) */
