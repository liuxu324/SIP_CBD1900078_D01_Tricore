...
#define IPV6_HDR_OFF_PAYLOADLENNBO      (IPV6_HDR_OFF_VERSIONTCFLNBO + 4u)
#define IPV6_HDR_OFF_NEXTHDR            (IPV6_HDR_OFF_PAYLOADLENNBO + 2u)
#define IPV6_HDR_OFF_HOPLIMIT           (IPV6_HDR_OFF_NEXTHDR + 1u)
#define IPV6_HDR_OFF_SRCADDR            (IPV6_HDR_OFF_HOPLIMIT + 1u)
#define IPV6_HDR_OFF_DSTADDR            (IPV6_HDR_OFF_SRCADDR + 16u)

/* IpV6 Fragment Extension Header Offsets */
#define IPV6_FRAG_EXT_HDR_OFF_NEXTHDR             0u
#define IPV6_FRAG_EXT_HDR_OFF_RESERVED            (IPV6_FRAG_EXT_HDR_OFF_NEXTHDR + 1u)
#define IPV6_FRAG_EXT_HDR_OFF_FRAGOFFNBO          (IPV6_FRAG_EXT_HDR_OFF_RESERVED + 1u)
#define IPV6_FRAG_EXT_HDR_OFF_IDNBO               (IPV6_FRAG_EXT_HDR_OFF_FRAGOFFNBO + 2u)
