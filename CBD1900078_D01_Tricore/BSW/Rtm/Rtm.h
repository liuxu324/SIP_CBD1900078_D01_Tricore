...
#define RTM_RELEASE_VERSION                         (0x04u)
...
extern VAR(uint32, RTM_VAR_NOINIT)                  Rtm_CpuLoadOverhead[RTM_NUMBER_OF_CORES];
...
extern VAR(uint8, RTM_VAR_NOINIT)                   Rtm_IsCpuLoadMeasurementPointResultOverflown[RTM_NUMBER_OF_CORES];

#  else
extern VAR(uint32, RTM_VAR_NOINIT)                  Rtm_CpuLoadOverhead;
