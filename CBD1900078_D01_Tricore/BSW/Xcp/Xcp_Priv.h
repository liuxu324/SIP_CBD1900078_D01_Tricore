...
/** \ingroup UNLOCK_IDX */
#define XCP_CRO_UNLOCK_MAX_KEY_SIZE(channel)        ((uint8)(Xcp_ChannelInfo[(channel)].MaxCto - 2u))
/** \ingroup UPLOAD_IDX */
...
/** \ingroup daqDef */
#define XCP_MAX_ODT_ENTRY_SIZE(XCP_CHANNEL_IDX)     (Xcp_ChannelInfo[(XCP_CHANNEL_IDX)].MaxDto - 1u) /* PRQA S 0788 */ /* MD_XCP_0788 */
