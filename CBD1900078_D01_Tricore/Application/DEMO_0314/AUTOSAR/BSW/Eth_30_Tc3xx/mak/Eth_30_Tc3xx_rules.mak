############################################################################### 
# File Name  : Eth_30_Tc3xx_rules.mak 
...
#------------------------------------------------------------------------------
# 1.00.00   2017-07-31  bgr     Initial creation
...
LIBRARIES_TO_BUILD      += Eth_30_Tc3xx
Eth_30_Tc3xx_FILES       = Eth_30_Tc3xx$(BSW_SRC_DIR)\Eth_30_Tc3xx*.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += Eth_30_Tc3xx$(BSW_SRC_DIR)\Eth_30_Tc3xx*.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Eth_30_Tc3xx*.c
