...
LIBRARIES_TO_BUILD      += TcpIpXcp
TcpIpXcp_FILES           = TcpIpXcp$(BSW_SRC_DIR)\TcpIpXcp.c

# e.g.: CC_FILES_TO_BUILD       += <MSN>\<MSN>.c <MSN>\<MSN>_Irq.c
CC_FILES_TO_BUILD       += TcpIpXcp$(BSW_SRC_DIR)\TcpIpXcp.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
