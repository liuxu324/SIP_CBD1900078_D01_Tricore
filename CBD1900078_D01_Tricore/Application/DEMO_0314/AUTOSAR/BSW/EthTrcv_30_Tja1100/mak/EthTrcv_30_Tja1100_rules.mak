...
# visdrr       David Roeder              Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version Sign    Description                                    #
# ----------   ------- ------  -----------------------------------------------#
# 2017/03/14   1.00    visdrr  Initial creation                               #
# 2018/01/19   3.00    visdrr  Adapted for new architecture                   #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.00.00                                                   #
###############################################################################
...
EthTrcv_30_Tja1100_FILES        = EthTrcv_30_Tja1100\EthTrcv_30_Tja1100.c EthTrcv_30_Tja1100\EthTrcv_30_Tja1100_Wakeup.c EthTrcv_30_Tja1100\EthTrcv_30_Tja1100_Hw.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += EthTrcv_30_Tja1100\EthTrcv_30_Tja1100.c EthTrcv_30_Tja1100\EthTrcv_30_Tja1100_Wakeup.c EthTrcv_30_Tja1100\EthTrcv_30_Tja1100_Hw.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
