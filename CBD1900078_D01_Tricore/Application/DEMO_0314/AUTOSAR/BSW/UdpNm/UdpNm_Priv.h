...
#  define UdpNm_VCfgGetActiveWakeupBitEnabled(Channel)   (UdpNm_ChannelConfigs[(Channel)].ActiveWakeupBitEnabled)
# endif
...
# define UdpNm_VcfgGetCarWakeupRxEnabled(Channel)        (UdpNm_ChannelConfigs[(Channel)].CarWakeupRxEnabled)
# define UdpNm_VcfgGetCarWakeupBitPosition(Channel)      (UdpNm_ChannelConfigs[(Channel)].CarwakeupBitPosition)
# define UdpNm_VcfgGetCarWakeupBytePosition(Channel)     (UdpNm_ChannelConfigs[(Channel)].CarWakeupBytePosition)
#endif
#if ( UDPNM_CAR_WAKEUP_FILTER_ENABLED == STD_ON )
# define UdpNm_VcfgGetCarWakeupFilterEnabled(Channel)    (UdpNm_ChannelConfigs[(Channel)].CarWakeupFilterEnabled)
# define UdpNm_VCfgGetCarWakeupFilterNodeId(Channel)     (UdpNm_ChannelConfigs[(Channel)].CarWakeupFilterNodeId)
#endif
...
/* Structure of Control Bit Vector
  ...
  |-----||---------|---------|---------|---------|---------|---------|---------|---------|
  |     ||         |         |         |         | NM      | Res     | Res     | Repeat  |
  | CBV || Res     | PNI     | Res     | Active  | Coord   | (NM     | (NM     | Message |
  |     ||         | Bit     |         | Wakeup  | Sleep   |  Coord  |  Coord  | Request |
  |     ||         |         |         |         | Ready   |  ID)    |  ID)    |         |
  +-----++---------+---------+---------+---------+---------+---------+---------+---------+
*/
...
/* Active Wakeup Bit*/
#define UDPNM_PDU_CBV_BIT_ACTIVE_WAKEUP_MASK  (0x10)
#define UDPNM_PDU_CBV_BIT_ACTIVE_WAKEUP_SHIFT (4u)
...
/* Set Active Wakeup Bit in Control Bit Vector of NM Tx PDU */
#define UdpNm_TxPdu_SetActiveWakeupBit(ChannelIdx) \
    UdpNm_GetTxCbv((ChannelIdx)) = (uint8)( ((uint32)UdpNm_GetTxCbv((ChannelIdx))) | (uint32)UDPNM_PDU_CBV_BIT_ACTIVE_WAKEUP_MASK )

/* Clear ActiveWakeup Bit in Control Bit Vector of NM Tx PDU */
#define UdpNm_TxPdu_ClearActiveWakeupBit(ChannelIdx) \
    UdpNm_GetTxCbv((ChannelIdx)) = (uint8)( ((uint32)UdpNm_GetTxCbv((ChannelIdx))) & (~(uint32)UDPNM_PDU_CBV_BIT_ACTIVE_WAKEUP_MASK) )
