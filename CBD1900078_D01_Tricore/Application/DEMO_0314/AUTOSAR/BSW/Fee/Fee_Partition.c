                                                                ...
                                                                uint8 sectorId)
{
    ...
    { 
        ...
        if((Fee_Sector_isDefective(sector_pt))                     /* SBSW_FEE_ConstPointer_refParam */
                || (Fee_Sector_isDefective(pi.currentSector_pt))) /* PRQA S 4558, 3415 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_13.5_queries */ /* SBSW_FEE_ConstPointer_refParam */
        { 
...
{
    return !self->readOnlyMode_bl; /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
...
{
    return !self->rejectAllMode_bl; /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
#endif
...
{
    return (!!self->requiresBlockCopy); /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
