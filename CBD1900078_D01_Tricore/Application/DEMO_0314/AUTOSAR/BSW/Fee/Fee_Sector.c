    ...
    Fee_Bool ReadOk)
{
    ...
    if (ReadOk)
    {
        ...
        else if((sectorId != 0xFFu) && (sectorId != 0u) && ((*intBuf & reservedMask) == 0uL))
        {
...
{
    return (!!self->isEmpty) ? 0uL : self->NextFreeAddress_t; /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
...
{
    return !((self->isEmpty) && (self->isFull)); /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
...
FEE_INTERN_FUNC(Fee_Bool) Fee_Sector_isDefective(Fee_SectorConstRefType self)
{
    return (Fee_Sector_isUsable(self) == FEE_FALSE) /* PRQA S 4403, 1881 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.4_compare_FeeBool_to_enum */ /* SBSW_FEE_ConstPointer_refParam */
            && (!self->isNfaConfirmed_bl); /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
...
FEE_INLINE_FUNC(Fee_Bool) Fee_Sector_isWriteable(Fee_SectorConstRefType self)
{
    return (Fee_Sector_isUsable(self)) /* PRQA S 4403 */ /* MD_FEE_10.3_essentially_boolean_type */ /* SBSW_FEE_ConstPointer_refParam */
            && (!self->isFull); /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
