...
FEE_INLINE_FUNC(void) Fee_InternalControlFssEnable(Fee_Bool doEnable)
{
    if((!Fee_Globals_t.ApiFlags.enableFss) == doEnable) /* PRQA S 1881, 4558 */ /*MD_FEE_10.4_compare_essentially_boolean_to_FeeBool, MD_FEE_10.1_Essentially_boolean_in_logical_expressions*/
    {
        Fee_GlobalSuspend();
 ...
 *
  ...
  Prevention: Review
   ...
   MD_FEE_StateMachine_Tracer
       Reason: Decrease dependencies of implementation and testsuite. This macro is only active when executed in vector test environment.
       Risk: None, it is not part of productive code.
       Prevention: n/a
*/
...
\ID SBSW_FEE_Statetracer_New_Transition
\DESCRIPTION Call testsuite function to inform about a new statemachine transition
\COUNTERMEASURE \N This function call is not part of productive code, since outside of testinvironment the macro is defined empty.
