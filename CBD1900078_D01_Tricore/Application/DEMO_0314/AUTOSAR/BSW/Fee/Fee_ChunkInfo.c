                                                                     ...
                                                                     Fee_BlockIdConstRefType blockId)
{
    ...
    if((!chunk->isDataChunk_bl) && (blockId != NULL_PTR)) /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    {
        const Fee_BitFieldType index = (Fee_BitFieldType)((!!chunk->isPseudoChunk_bl) ? blockId->Tag : blockId->DataIndex); /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
...
#       endif
            ...
            instExpOk = (((self->isDataChunk_bl) && (instExp > 0u)) || /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
                         ((!self->isDataChunk_bl) && (instExp == 0u))); /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
            ...
            /* PRQA S 3344 1 */ /* MD_FEE_13.2_boolean */
            if((reservedBits == 0uL) && (self->PayloadSize_b16 > 0u) && (instExpOk) && /* PRQA S 4538 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
...
FEE_INTERN_FUNC(Fee_Bool) Fee_ChunkInfo_AssignSector(Fee_ChunkInfoRefType self, Fee_SectorRefType sector_pt)
{
    ...
    if(!self->isDataChunk_bl) /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    {
...
#   endif
    ...
    if(linkStatus == FEE_MNGMT_CONSISTENT)
    {
        ...
        if((!Fee_Sector_containsAbsAddr(sector, linkAddress - 1u))     /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */     /* SBSW_FEE_ConstPointer_refParam */
                                                                        ...
                                                                        Fee_Bool ReadOk)
{
    ...
    if(!self->isPseudoChunk_bl) /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    {
                                                          ...
                                                          Fee_IntBuffer_u32PtrType buffer_au32)
{
    ...
    const uint32 dataIndexField = (uint32)((!!self->isDataChunk_bl) ? blockId_pt->DataIndex : self->InstanceExponent_b8); /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    uint32 temp;
...
{
    return !!self->isDataChunk_bl; /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* !! makes a a boolean expression -> no casts, etc */
}
...
FEE_INLINE_FUNC(Fee_Bool) Fee_ChunkInfo_isLinkTable(Fee_ChunkInfoConstRefType self)
{
    /* PRQA S 4403, 4558 1 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
...
{
    /* PRQA S 3344 1 */ /* MD_FEE_13.2_boolean */
    return (Fee_ChunkInfo_isLinkTable(self)) && (self->isPseudoChunk_bl); /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* SBSW_FEE_ConstPointer_refParam */
}
...
{
    return !self->wasLinkWritten_bl; /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
...
{
    return !self->isLinkDefective_bl; /* PRQA S 4403, 4558 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
                                                                  ...
                                                                  struct Fee_BlockIdStruct searchBlock, Fee_Bool flsReadOk)
{
    ...
    if((Fee_ChunkInfo_EvaluateHeaderData(&chunk, &blockId_tloc, headerBuffer_au32, flsReadOk) == FEE_MNGMT_CONSISTENT)
                    ...
                    && (((searchBlock.DataIndex) == (blockId_tloc.DataIndex)) || (Fee_ChunkInfo_isLinkTable(&chunk))) /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* SBSW_FEE_ConstPointer_refParam */
                    && (Fee_ChunkInfo_Equals(&chunk, mostRecentChunk_pt))) /* PRQA S 4558 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* SBSW_FEE_ConstPointer_refParam */ /* SBSW_FEE_ConstPointer_refParam */
    {
