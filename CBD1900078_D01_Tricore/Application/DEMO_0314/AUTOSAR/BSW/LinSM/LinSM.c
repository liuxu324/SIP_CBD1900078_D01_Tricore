 ...
 * \trace SPEC-17422 */
#if (  (LINSM_SW_MAJOR_VERSION != (0x06u)) \
    || (LINSM_SW_MINOR_VERSION != (0x00u)) \
 ...
 * \trace SPEC-17422 */
#if (  (LINSM_CBK_MAJOR_VERSION != (0x06u)) \
    || (LINSM_CBK_MINOR_VERSION != (0x00u)) \
 ...
 * \trace SPEC-17422 */
#if (  (LINSM_TPS_MAJOR_VERSION != (0x06u)) \
    || (LINSM_TPS_MINOR_VERSION != (0x00u)) \
...
# else
  LINSM_DUMMY_STATEMENT( errorId ); /* PRQA S 3112, 3199 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
# endif
  LINSM_DUMMY_STATEMENT_CONST( channel ); /* PRQA S 3112, 3199 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
} /* LinSM_SwitchTransceiver() */
...
# else
        LINSM_DUMMY_STATEMENT_CONST( network ); /* PRQA S 3112, 3199 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
...
# endif
...
#else
  LINSM_DUMMY_STATEMENT( ecumErrorId ); /* PRQA S 3112, 3199 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
#endif
  ...
  LINSM_DUMMY_STATEMENT_CONST( ConfigPtr ); /* PRQA S 3112, 3199 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
#endif
} /* LinSM_Init() */
...
#else
    LINSM_DUMMY_STATEMENT( success ); /* PRQA S 3112, 3199 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
    LINSM_DUMMY_STATEMENT( network ); /* PRQA S 3112, 3199 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
#endif
  }
