 ...
 *            2018-07-26  vismda  ESCAN00100303            <Up>_SoAdTpTxConfirmation is called before transmission is
 *                                                         finished
 ...
 *   12.01.00 2018-08-21  vismda  STORYC-6033              [ETH] Support different VLAN priorities defined by the data
 *                                                         definition in SoAD with BSD option for Linux SoAd
 ...
 *            2018-11-16  vismda  ESCAN00100714            Socket connection is not handled properly if Abort-flag is
 *                                                         set to TRUE.
...
# define SOAD_SW_MAJOR_VERSION                            (12u)
# define SOAD_SW_MINOR_VERSION                            (1u)
# define SOAD_SW_PATCH_VERSION                            (3u)
