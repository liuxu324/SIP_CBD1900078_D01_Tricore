...
/* Stack: SchMTask_Core0 (1024 Byte) */
group OS_STACK_SCHMTASK_CORE0_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_SCHMTASK_CORE0_VAR_NOINIT";
  reserved ".pad.OS_STACK_SCHMTASK_CORE0_VAR_NOINIT" (size=16);
}
"_OS_STACK_SCHMTASK_CORE0_VAR_NOINIT_START" = "_lc_gb_OS_STACK_SCHMTASK_CORE0_VAR_NOINIT_GROUP";
"_OS_STACK_SCHMTASK_CORE0_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_SCHMTASK_CORE0_VAR_NOINIT";
