...
/* User: [SchMTask_Core0] */
extern OS_STACK_DECLARE(OsCfg_Stack_SchMTask_Core0_Dyn, OS_CFG_SIZE_SCHMTASK_CORE0_STACK);
...
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_SchMTask_Core0;
