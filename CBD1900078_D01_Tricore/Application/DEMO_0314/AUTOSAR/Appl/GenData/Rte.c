...
FUNC(void, RTE_CODE) SchM_Init(void)
{
  ...
  if (id == OS_CORE_ID_0)
  {
    ...
    (void)SetRelAlarm(Rte_Al_TE2_SchMTask_Core0_0_20ms, RTE_MSEC_SystemTimer_Core0(0) + (TickType)1, RTE_MSEC_SystemTimer_Core0(20)); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)SetRelAlarm(Rte_Al_TE_CanTp_CanTp_MainFunction, RTE_MSEC_SystemTimer_Core0(0) + (TickType)1, RTE_MSEC_SystemTimer_Core0(5)); /* PRQA S 3417 */ /* MD_Rte_Os */
  ...
  {
    /* activate the alarms used for TimingEvents */
    (void)SetRelAlarm(Rte_Al_TE1_EcuM_EcuM_MainFunction, RTE_MSEC_SystemTimer_Core1(0) + (TickType)1, RTE_MSEC_SystemTimer_Core1(10)); /* PRQA S 3417 */ /* MD_Rte_Os */
  ...
  {
    /* activate the alarms used for TimingEvents */
    (void)SetRelAlarm(Rte_Al_TE2_EcuM_EcuM_MainFunction, RTE_MSEC_SystemTimer_Core2(0) + (TickType)1, RTE_MSEC_SystemTimer_Core2(10)); /* PRQA S 3417 */ /* MD_Rte_Os */
  ...
  {
    /* activate the alarms used for TimingEvents */
    (void)SetRelAlarm(Rte_Al_TE3_EcuM_EcuM_MainFunction, RTE_MSEC_SystemTimer_Core3(0) + (TickType)1, RTE_MSEC_SystemTimer_Core3(10)); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  {
    /* activate the alarms used for TimingEvents */
    (void)SetRelAlarm(Rte_Al_TE_CtLed5Type_Led5BlinkRunnable, RTE_SEC_SystemTimer_Core5(0) + (TickType)1, RTE_SEC_SystemTimer_Core5(1)); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)SetRelAlarm(Rte_Al_TE_CtLed4Type_Led4BlinkRunnable, RTE_MSEC_SystemTimer_Core4(0) + (TickType)1, RTE_MSEC_SystemTimer_Core4(500)); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)SetRelAlarm(Rte_Al_TE_CtLed3Type_Led3BlinkRunnable, RTE_MSEC_SystemTimer_Core3(0) + (TickType)1, RTE_MSEC_SystemTimer_Core3(400)); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)SetRelAlarm(Rte_Al_TE_CtLed2Type_Led2BlinkRunnable, RTE_MSEC_SystemTimer_Core2(0) + (TickType)1, RTE_MSEC_SystemTimer_Core2(300)); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)SetRelAlarm(Rte_Al_TE_CtLed1Type_Led1BlinkRunnable, RTE_MSEC_SystemTimer_Core1(0) + (TickType)1, RTE_MSEC_SystemTimer_Core1(200)); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)SetRelAlarm(Rte_Al_TE_CtLed0Type_Led0BlinkRunnable, RTE_MSEC_SystemTimer_Core0(0) + (TickType)1, RTE_MSEC_SystemTimer_Core0(100)); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Stop(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  {
    /* deactivate alarms */
    (void)CancelAlarm(Rte_Al_TE_CtLed0Type_Led0BlinkRunnable); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)CancelAlarm(Rte_Al_TE_CtLed1Type_Led1BlinkRunnable); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)CancelAlarm(Rte_Al_TE_CtLed2Type_Led2BlinkRunnable); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)CancelAlarm(Rte_Al_TE_CtLed3Type_Led3BlinkRunnable); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)CancelAlarm(Rte_Al_TE_CtLed4Type_Led4BlinkRunnable); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)CancelAlarm(Rte_Al_TE_CtLed5Type_Led5BlinkRunnable); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(void, RTE_CODE) SchM_Deinit(void)
{
  ...
  if (id == OS_CORE_ID_0)
  {
    ...
    (void)CancelAlarm(Rte_Al_TE2_SchMTask_Core0_0_20ms); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(void, RTE_CODE) Rte_COMCbk_sig_State_RearInteriorLight_omsg_Receive_oCAN00_63323183_Rx(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{

  if (Rte_InitState == RTE_STATE_INIT)
  {
    (void)Com_ReceiveSignal(ComConf_ComSignal_sig_State_RearInteriorLight_omsg_Receive_oCAN00_63323183_Rx, (&Rte_sig_State_RearInteriorLight_omsg_Receive_oCAN00_63323183_Rx)); /* PRQA S 3453 */ /* MD_MSR_19.7 */
  }
...
FUNC(void, RTE_CODE) Rte_ComSendSignalProxyPeriodic(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  if (Rte_SystemApplication_OsCore4_TxUpdateFlags.Rte_TxUpdateProxy_CtLed4Type_sig_RearInteriorLight_RearInteriorLight != Rte_SystemApplication_OsCore0_TxUpdateFlags.Rte_TxUpdateProxy_CtLed4Type_sig_RearInteriorLight_RearInteriorLight)
  {
    updateAction = Rte_SystemApplication_OsCore4_TxUpdateFlags.Rte_TxUpdate_CtLed4Type_sig_RearInteriorLight_RearInteriorLight;
  }
  if (updateAction == RTE_COM_SENDSIGNALPROXY_SEND)
  {
    (void)GetSpinlock(Rte_Spinlock_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx);
    (void)Com_SendSignal(ComConf_ComSignal_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx, (&Rte_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx)); /* PRQA S 0850 */ /* MD_MSR_19.8 */
    Rte_SystemApplication_OsCore0_TxUpdateFlags.Rte_TxUpdateProxy_CtLed4Type_sig_RearInteriorLight_RearInteriorLight = Rte_SystemApplication_OsCore4_TxUpdateFlags.Rte_TxUpdateProxy_CtLed4Type_sig_RearInteriorLight_RearInteriorLight;
    (void)ReleaseSpinlock(Rte_Spinlock_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx);
  }
