...
/* User: [CounterIsr_SystemTimer_Core3, XSignalIsr_OsCore3] */
...
/* User: [CounterIsr_SystemTimer_Core4, XSignalIsr_OsCore4] */
...
/* User: [CounterIsr_SystemTimer_Core5, XSignalIsr_OsCore5] */
...
#define OS_START_SEC_STACK_SCHMTASK_CORE0_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */

/* Shared Task stack: SchMTask_Core0 */
/* User: [SchMTask_Core0] */
OS_STACK_DECLARE(OsCfg_Stack_SchMTask_Core0_Dyn, OS_CFG_SIZE_SCHMTASK_CORE0_STACK);

#define OS_STOP_SEC_STACK_SCHMTASK_CORE0_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
...
/*! Stack configuration data: SchMTask_Core0 */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_SchMTask_Core0 =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_SchMTask_Core0_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_SchMTask_Core0_Dyn)
};
