 ...
 * Priority: 50
 * Schedule: FULL
 * Alarm:    Cycle Time 0.3 s Alarm Offset 0 s
 *********************************************************************************************************************/
TASK(ApplTask_Core2) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(SchMTask_Core2) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
