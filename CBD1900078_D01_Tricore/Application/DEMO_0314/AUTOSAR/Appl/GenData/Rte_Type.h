...
extern VAR(boolean, RTE_VAR_INIT_NOCACHE) Rte_sig_State_RearInteriorLight_omsg_Receive_oCAN00_63323183_Rx; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
extern VAR(boolean, RTE_VAR_INIT_NOCACHE) Rte_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
typedef struct
{
  Rte_BitType Rte_TxUpdateProxy_CtLed4Type_sig_RearInteriorLight_RearInteriorLight : 1;
} Rte_SystemApplication_OsCore0_TxUpdateFlagsType;

#  define RTE_START_SEC_VAR_NOCACHE_ZERO_INIT_UNSPECIFIED
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

extern VAR(Rte_SystemApplication_OsCore0_TxUpdateFlagsType, RTE_VAR_ZERO_INIT_NOCACHE) Rte_SystemApplication_OsCore0_TxUpdateFlags; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
typedef struct
{
  Rte_BitType Rte_TxUpdate_CtLed4Type_sig_RearInteriorLight_RearInteriorLight : 2;
  Rte_BitType Rte_TxUpdateProxy_CtLed4Type_sig_RearInteriorLight_RearInteriorLight : 1;
} Rte_SystemApplication_OsCore4_TxUpdateFlagsType;

#  define RTE_START_SEC_VAR_SystemApplication_OsCore4_NOCACHE_ZERO_INIT_UNSPECIFIED
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

extern VAR(Rte_SystemApplication_OsCore4_TxUpdateFlagsType, RTE_VAR_ZERO_INIT_NOCACHE) Rte_SystemApplication_OsCore4_TxUpdateFlags; /* PRQA S 0850 */ /* MD_MSR_19.8 */
