...
VAR(boolean, RTE_VAR_INIT_NOCACHE) Rte_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx = FALSE; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
 ...
 *********************************************************************************************************************/
#define RTE_START_SEC_VAR_SystemApplication_OsCore4_NOCACHE_ZERO_INIT_UNSPECIFIED
#include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

VAR(Rte_SystemApplication_OsCore4_TxUpdateFlagsType, RTE_VAR_ZERO_INIT_NOCACHE) Rte_SystemApplication_OsCore4_TxUpdateFlags = {
  0,
  0
}; /* PRQA S 0850 */ /* MD_MSR_19.8 */

#define RTE_STOP_SEC_VAR_SystemApplication_OsCore4_NOCACHE_ZERO_INIT_UNSPECIFIED
#include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */


#define Rte_SystemApplication_OsCore4_TxUpdateFlagsInit() (Rte_MemClr(&Rte_SystemApplication_OsCore4_TxUpdateFlags, sizeof(Rte_SystemApplication_OsCore4_TxUpdateFlagsType)))
...
FUNC(void, RTE_CODE) Rte_InitMemory_SystemApplication_OsCore4(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_SystemApplication_OsCore4_TxUpdateFlagsInit();

  /* set default values for internal data */
  Rte_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx = FALSE;
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtLed4Type_sig_RearInteriorLight_RearInteriorLight(boolean data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  (void)GetSpinlock(Rte_Spinlock_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx);
  Rte_sig_RearInteriorLight_omsg_Transmit_oCAN00_49a633c1_Tx = *(&data);
  Rte_SystemApplication_OsCore4_TxUpdateFlags.Rte_TxUpdate_CtLed4Type_sig_RearInteriorLight_RearInteriorLight = RTE_COM_SENDSIGNALPROXY_SEND;
  Rte_SystemApplication_OsCore4_TxUpdateFlags.Rte_TxUpdateProxy_CtLed4Type_sig_RearInteriorLight_RearInteriorLight = !Rte_SystemApplication_OsCore0_TxUpdateFlags.Rte_TxUpdateProxy_CtLed4Type_sig_RearInteriorLight_RearInteriorLight;
 ...
 *********************************************************************************************************************/
TASK(ApplTask_Core4) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(SchMTask_Core4) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
