...
CONST(Os_Hal_IntIsrConfigType, OS_CONST) OsCfg_Hal_IntIsr_CounterIsr_SystemTimer_Core3 =
{
  /* .Level          = */ 20,
  /* .Source         = */ 0x318uL,
  /* .CoreAssignment = */ 4
...
CONST(Os_Hal_IntIsrConfigType, OS_CONST) OsCfg_Hal_IntIsr_CounterIsr_SystemTimer_Core4 =
{
  /* .Level          = */ 20,
  /* .Source         = */ 0x320uL,
  /* .CoreAssignment = */ 5
...
CONST(Os_Hal_IntIsrConfigType, OS_CONST) OsCfg_Hal_IntIsr_CounterIsr_SystemTimer_Core5 =
{
  /* .Level          = */ 21,
  /* .Source         = */ 0x328uL,
  /* .CoreAssignment = */ 6
