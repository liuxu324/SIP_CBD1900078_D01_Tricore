...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Disable_DM(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Enable_DM(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_Disable(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_EnableNoinit(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_Disable(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_EnableNoinit(void);
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN01_29515a4f_RX_DM(void);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN01_29515a4f_RX(void);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN01_29515a4f_TX(void);
...
/*lint -restore */
CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[26] = {
  ...
  { /*    20 */ BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Disable_DM      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN01_29515a4f_Disable_DM] */
  { /*    21 */ BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Enable_DM       },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN01_29515a4f_Enable_DM] */
  { /*    22 */ BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN01_29515a4f_RX_Disable] */
  { /*    23 */ BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN01_29515a4f_RX_EnableNoinit] */
  { /*    24 */ BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN01_29515a4f_TX_Disable] */
  { /*    25 */ BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_EnableNoinit }   /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN01_29515a4f_TX_EnableNoinit] */
};
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
CONST(BswM_CanSMChannelMappingType, BSWM_CONST) BswM_CanSMChannelMapping[2] = {
    /* Index    ExternalId                              ImmediateUserEndIdx  ImmediateUserStartIdx        Referable Keys */
  { /*     0 */ ComMConf_ComMChannel_CN_CAN00_5e566ad9,                  1u,                    0u },  /* [CANSM_CHANNEL_0, MRP_CC_CanSMIndication_CN_CAN00_5e566ad9] */
  { /*     1 */ ComMConf_ComMChannel_CN_CAN01_29515a4f,                  2u,                    1u }   /* [CANSM_CHANNEL_1, MRP_CC_CanSMIndication_CN_CAN01_29515a4f] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
CONST(BswM_ComMChannelMappingType, BSWM_CONST) BswM_ComMChannelMapping[2] = {
    /* Index    ExternalId                                    Referable Keys */
  { /*     0 */ ComMConf_ComMChannel_CN_CAN00_5e566ad9 },  /* [COMM_CHANNEL_0, MRP_ESH_ComMIndication_CN_CAN00_5e566ad9] */
  { /*     1 */ ComMConf_ComMChannel_CN_CAN01_29515a4f }   /* [COMM_CHANNEL_1, MRP_ESH_ComMIndication_CN_CAN01_29515a4f] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(BswM_GenericMappingType, BSWM_CONST) BswM_GenericMapping[3] = {
  ...
  { /*     0 */ 230       ,                                          3u,                                            2u, BSWM_GENERICVALUE_ESH_State_ESH_INIT                          },  /* [GENERIC_0, MRP_ESH_State] */
  { /*     1 */ 231       ,                                          4u,                                            3u, BSWM_GENERICVALUE_ESH_DemInitStatus_DEM_INITIALIZED           },  /* [GENERIC_1, MRP_ESH_DemInitStatus] */
...
CONST(BswM_ImmediateUserType, BSWM_CONST) BswM_ImmediateUser[4] = {
  ...
  { /*     1 */      0x01u,                                    6u,                                      3u },  /* [Name: CC_CanSMIndication_CN_CAN01_29515a4f] */  /* [MRP_CC_CanSMIndication_CN_CAN01_29515a4f, CANSM_CHANNEL_1] */
  { /*     2 */      0x03u,                                   14u,                                      6u },  /* [Name: ESH_State]                            */  /* [MRP_ESH_State, GENERIC_0] */
  { /*     3 */      0x00u, BSWM_NO_RULESINDENDIDXOFIMMEDIATEUSER, BSWM_NO_RULESINDSTARTIDXOFIMMEDIATEUSER }   /* [Name: ESH_DemInitStatus]                    */  /* [MRP_ESH_DemInitStatus, GENERIC_1] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[18] = {
  ...
  { /*     3 */ 12u, BswM_Rule_ESH_RunToPostRun           },  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ModeNotification, MRP_ESH_ComMIndication_CN_CAN00_5e566ad9, MRP_ESH_ComMIndication_CN_CAN01_29515a4f, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, NoPartitions] */
  { /*     4 */ 13u, BswM_Rule_ESH_RunToPostRunNested     },  /* [R_ESH_RunToPostRunNested, NoPartitions] */
  { /*     5 */ 14u, BswM_Rule_ESH_WaitToShutdown         },  /* [R_ESH_WaitToShutdown, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  { /*     6 */ 16u, BswM_Rule_ESH_WakeupToPrep           },  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification, NoPartitions] */
  { /*     7 */ 15u, BswM_Rule_ESH_WaitToWakeup           },  /* [R_ESH_WaitToWakeup, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  { /*     8 */ 17u, BswM_Rule_ESH_WakeupToRun            },  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification, NoPartitions] */
  { /*     9 */  6u, BswM_Rule_ESH_DemInit                },  /* [R_ESH_DemInit, NoPartitions] */
  { /*    10 */  7u, BswM_Rule_ESH_InitToWakeup           },  /* [R_ESH_InitToWakeup, MRP_ESH_State, NoPartitions] */
  { /*    11 */ 10u, BswM_Rule_ESH_PostRunToPrepNested    },  /* [R_ESH_PostRunToPrepNested, NoPartitions] */
  { /*    12 */  9u, BswM_Rule_ESH_PostRunNested          },  /* [R_ESH_PostRunNested, NoPartitions] */
  { /*    13 */  8u, BswM_Rule_ESH_PostRun                },  /* [R_ESH_PostRun, MRP_ESH_State, MRP_ESH_ModeNotification, NoPartitions] */
  { /*    14 */ 11u, BswM_Rule_ESH_PrepToWait             },  /* [R_ESH_PrepToWait, MRP_ESH_State, MRP_ESH_ModeNotification, NoPartitions] */
  { /*    15 */  4u, BswM_Rule_CC_CN_CAN01_29515a4f_RX_DM },  /* [R_CC_CN_CAN01_29515a4f_RX_DM, MRP_CC_CanSMIndication_CN_CAN01_29515a4f, NoPartitions] */
  { /*    16 */  3u, BswM_Rule_CC_CN_CAN01_29515a4f_RX    },  /* [R_CC_CN_CAN01_29515a4f_RX, MRP_CC_CanSMIndication_CN_CAN01_29515a4f, NoPartitions] */
  { /*    17 */  5u, BswM_Rule_CC_CN_CAN01_29515a4f_TX    }   /* [R_CC_CN_CAN01_29515a4f_TX, MRP_CC_CanSMIndication_CN_CAN01_29515a4f, NoPartitions] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
CONST(BswM_RulesIndType, BSWM_CONST) BswM_RulesInd[14] = {
  ...
  /*     3 */      15u,  /* [MRP_CC_CanSMIndication_CN_CAN01_29515a4f] */
  /*     4 */      16u,  /* [MRP_CC_CanSMIndication_CN_CAN01_29515a4f] */
  /*     5 */      17u,  /* [MRP_CC_CanSMIndication_CN_CAN01_29515a4f] */
  /*     6 */       3u,  /* [MRP_ESH_State] */
  /*     7 */       5u,  /* [MRP_ESH_State] */
  /*     8 */       6u,  /* [MRP_ESH_State] */
  /*     9 */       7u,  /* [MRP_ESH_State] */
  /*    10 */       8u,  /* [MRP_ESH_State] */
  /*    11 */      10u,  /* [MRP_ESH_State] */
  /*    12 */      13u,  /* [MRP_ESH_State] */
  /*    13 */      14u   /* [MRP_ESH_State] */
};
...
VAR(uBswM_ActionListQueueType, BSWM_VAR_NOINIT) BswM_ActionListQueue;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
  ...
  /*    20 */  /* [AL_CC_AL_CN_CAN01_29515a4f_Disable_DM] */
  /*    21 */  /* [AL_CC_AL_CN_CAN01_29515a4f_Enable_DM] */
  /*    22 */  /* [AL_CC_AL_CN_CAN01_29515a4f_RX_Disable] */
  /*    23 */  /* [AL_CC_AL_CN_CAN01_29515a4f_RX_EnableNoinit] */
  /*    24 */  /* [AL_CC_AL_CN_CAN01_29515a4f_TX_Disable] */
  /*    25 */  /* [AL_CC_AL_CN_CAN01_29515a4f_TX_EnableNoinit] */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
VAR(CanSM_BswMCurrentStateType, BSWM_VAR_NOINIT) BswM_CanSMChannelState[2];
  /* Index        Referable Keys  */
  /*     0 */  /* [CANSM_CHANNEL_0, MRP_CC_CanSMIndication_CN_CAN00_5e566ad9] */
  /*     1 */  /* [CANSM_CHANNEL_1, MRP_CC_CanSMIndication_CN_CAN01_29515a4f] */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
VAR(ComM_ModeType, BSWM_VAR_NOINIT) BswM_ComMChannelState[2];
  /* Index        Referable Keys  */
  /*     0 */  /* [COMM_CHANNEL_0, MRP_ESH_ComMIndication_CN_CAN00_5e566ad9] */
  /*     1 */  /* [COMM_CHANNEL_1, MRP_ESH_ComMIndication_CN_CAN01_29515a4f] */
...
VAR(BswM_ModeRequestQueueType, BSWM_VAR_NOINIT) BswM_ModeRequestQueue[4];
  ...
  /*     1 */  /* [MRP_CC_CanSMIndication_CN_CAN01_29515a4f, CANSM_CHANNEL_1] */
  /*     2 */  /* [MRP_ESH_State, GENERIC_0] */
  /*     3 */  /* [MRP_ESH_DemInitStatus, GENERIC_1] */
...
VAR(BswM_RuleStatesType, BSWM_VAR_NOINIT) BswM_RuleStates[18];
  ...
  /*     3 */  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ModeNotification, MRP_ESH_ComMIndication_CN_CAN00_5e566ad9, MRP_ESH_ComMIndication_CN_CAN01_29515a4f, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, NoPartitions] */
  ...
  /*    15 */  /* [R_CC_CN_CAN01_29515a4f_RX_DM, MRP_CC_CanSMIndication_CN_CAN01_29515a4f, NoPartitions] */
  /*    16 */  /* [R_CC_CN_CAN01_29515a4f_RX, MRP_CC_CanSMIndication_CN_CAN01_29515a4f, NoPartitions] */
  /*    17 */  /* [R_CC_CN_CAN01_29515a4f_TX, MRP_CC_CanSMIndication_CN_CAN01_29515a4f, NoPartitions] */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_RunToPostRun(void)
{
  ...
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_CAN01_29515a4f, FALSE);
  /*lint -save -e534 *//* PRQA S 3109, 3200 1 */ /* MD_MSR_14.3, MD_BswM_3200 */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_WakeupToRun(void)
{
  ...
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_CAN01_29515a4f, TRUE);
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Disable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Disable_DM(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Rx_f4031692, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkDmControlInvocation();
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Enable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Enable_DM(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Rx_f4031692, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkDmControlInvocation();
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_Disable(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Rx_f4031692, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Rx_f4031692, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_EnableNoinit(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Rx_f4031692, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Rx_f4031692, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_Disable(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Tx_a259b114, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Tx_a259b114, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_EnableNoinit(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Tx_a259b114, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN01_Tx_a259b114, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN01_29515a4f_RX_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN01_29515a4f_RX_DM(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN01_29515a4f_RX_DM. */
  if(BswM_GetCanSMChannelState(1) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_RX_DM) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_RX_DM, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Enable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN01_29515a4f_Enable_DM;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_RX_DM) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_RX_DM, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN01_29515a4f_Disable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN01_29515a4f_Disable_DM;
    }
  }
  return retVal;
}
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN01_29515a4f_RX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN01_29515a4f_RX(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN01_29515a4f_RX. */
  if(BswM_GetCanSMChannelState(1) != CANSM_BSWM_NO_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_RX) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_RX, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN01_29515a4f_RX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_RX) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_RX, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN01_29515a4f_RX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN01_29515a4f_RX_Disable;
    }
  }
  return retVal;
}
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN01_29515a4f_TX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN01_29515a4f_TX(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN01_29515a4f_TX. */
  if(BswM_GetCanSMChannelState(1) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_TX) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_TX, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN01_29515a4f_TX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_TX) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN01_29515a4f_TX, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN01_29515a4f_TX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN01_29515a4f_TX_Disable;
    }
  }
  return retVal;
}
