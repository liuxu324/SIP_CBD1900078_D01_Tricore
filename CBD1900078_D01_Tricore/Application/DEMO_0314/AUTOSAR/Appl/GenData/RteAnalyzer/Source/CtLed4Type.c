 ...
 *********************************************************************************************************************/
  ...
  boolean Read_sig_State_RearInteriorLight_State_RearInteriorLight;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  fct_status = TSC_CtLed4Type_Rte_Read_sig_State_RearInteriorLight_State_RearInteriorLight(&Read_sig_State_RearInteriorLight_State_RearInteriorLight);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CtLed4Type_Rte_Write_sig_RearInteriorLight_RearInteriorLight(Rte_InitValue_sig_RearInteriorLight_RearInteriorLight);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
