 ...
 *********************************************************************************************************************/
  ...
  ComM_StateType CN_CAN01_29515a4f = COMM_NO_COM_NO_PENDING_REQUEST;
  
  (void)ComM_GetState(ComMConf_ComMChannel_CN_CAN00_5e566ad9, &CN_CAN00_5e566ad9); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_CAN01_29515a4f, &CN_CAN01_29515a4f); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  
  if((CN_CAN00_5e566ad9 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_CAN01_29515a4f != COMM_NO_COM_NO_PENDING_REQUEST))
  {
