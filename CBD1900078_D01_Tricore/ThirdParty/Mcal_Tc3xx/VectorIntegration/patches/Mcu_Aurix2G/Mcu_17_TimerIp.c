...
#define MCU_GET_SETBIT_POS(REG)     ((uint8)(0x20U - \
                                          Mcal_CountLeadingZeros(REG) - 0x1U))
...
/* MISRA2012_RULE_5_5_JUSTIFICATION: External identifiers going beyond 32 chars.
  in generated code due to Autosar Naming constraints.*/
#define MCU_17_TIMERIP_START_SEC_CONFIG_DATA_ASIL_B_GLOBAL_8
/* MISRA2012_RULE_4_10_JUSTIFICATION: Memmap header is repeatedly included
   without safeguard. It complies to Autosar guidelines. */
/* MISRA2012_RULE_20_1_JUSTIFICATION: Memmap header included as per Autosar
   guidelines. */
...
extern const uint8 Mcu_17_Stm_ChUserData[MCU_17_STM_NO_OF_TIMERS];
...
/* MISRA2012_RULE_5_5_JUSTIFICATION: External identifiers going beyond 32 chars.
  in generated code due to Autosar Naming constraints.*/
#define MCU_17_TIMERIP_STOP_SEC_CONFIG_DATA_ASIL_B_GLOBAL_8
/* MISRA2012_RULE_4_10_JUSTIFICATION: Memmap header is repeatedly included
   without safeguard. It complies to Autosar guidelines. */
/* MISRA2012_RULE_20_1_JUSTIFICATION: Memmap header included as per Autosar
   guidelines. */
...
)
{
  ...
  /* [cover parentID={2AAB3901-3468-4c2e-BDF8-072D5A4BC015}]
   * Is STM comparator counter equal to Maximum count
   * [/cover] */
   ...
   * [/cover] */
  IrqStatus = Mcal_GetBitAtomic((Mcu_17_Stm[StmTimerId]->ICR.U),\
                                 StmCmpIRBit,\
                                 STM_ICR_CMPIR_LEN);
  ...
  /*[cover parentID={05647AE6-1DD8-4e0e-B0B2-90942B6CA907}][/cover]*/
    ...
    UserId = Mcu_17_Stm_ChUserData[StmTimerId];
...
)
{
  ...
  /* Check which OGU unit raised the interrupt */
  /* [cover parentID={34397A1A-EBEE-4fdd-A8B0-A0A3E017B894}]
   * Check which OGU unit raised the interrupt*/
  do
  {
     ...
     * [/cover] */
    if(0U != \
        Mcal_GetBitAtomic(*EruIgpPtr, EruIgpPos, ERU_IGP_LEN))
    {
     ...
     /* Calculate the mask value depending on the ERS used */
     IrqStatusMask = ((uint32)ERU_BIT_SET << EruChInputUnit);

     /* Extract the Interrupt status of the ERS channel */
     /* MISRA2012_RULE_11_4_JUSTIFICATION: SFR access. No side effects
      * foreseen by violating this MISRA rule. */
     IrqStatus = MODULE_SCU.EIFR.U & IrqStatusMask;

     /* [cover parentID={D4806232-40B4-4e41-98E5-D17838310946}]
      * Is Interrupt request status greater than zero
      * [/cover] */
     if(IrqStatus > ERU_BIT_CLEAR)
     {
       /* Is UserId information a valid one */
       /* [cover parentID={7F83B262-A2BF-44c1-91B9-D0E6D6BB52EB}]
        * Validity Check of User Id
        * [/cover] */
       if((UserId != (uint8)TIMER_IP_NO_USER) && \
                                      (UserId <= (uint8)TIMER_NO_OF_CALLBACK))
      ...
      /*[cover parentID={D7B3ED53-78CD-4695-B366-2BD2489397CA}][/cover]*/
          ...
          * User Id has a callback function or not
          * [/cover] */
         if(Mcu_17_Timer_DrivFuncCallbackLst[(UserId - (uint8)ERU_BIT_SET)] != \
                                                                     NULL_PTR)
         {
  ...
  /* [cover parentID={F5125D8F-ED9B-4303-AC74-F4CE93E7BDB8}]
    ...
    EruChOutputUnit += ERU_OGU_OFFSET;

  } while(EruChOutputUnit < MCU_17_ERU_NO_OF_OGU);
  /*[/cover] */
}
