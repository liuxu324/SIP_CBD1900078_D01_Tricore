...
derivative tc39
{
  ...
  section_layout :vtc:linear
  {
    ...
    group (ordered)
    {
      ...
      group startptr_tc4 (run_addr=LCF_STARTPTR_CPU4)
      {
        select "(.text.startptr_cpu4*)";
      }
      group startptr_tc5 (run_addr=LCF_STARTPTR_CPU5)
      {
        select "(.text.startptr_cpu5*)";
      }
