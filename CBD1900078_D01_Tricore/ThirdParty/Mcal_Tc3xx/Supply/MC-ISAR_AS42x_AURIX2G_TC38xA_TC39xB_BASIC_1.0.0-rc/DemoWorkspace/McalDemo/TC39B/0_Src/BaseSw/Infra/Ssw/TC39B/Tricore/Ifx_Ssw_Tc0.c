...
static void __StartUpSoftware_Phase6(void)
{
    ...
    Ifx_Ssw_startCore(&MODULE_CPU4, (unsigned int)&__Core4_start);           /*The status returned by function call is ignored */
#endif
#if (IFX_CFG_SSW_ENABLE_TRICORE4 == 0)
#if (IFX_CFG_SSW_ENABLE_TRICORE5 != 0)
    Ifx_Ssw_startCore(&MODULE_CPU5, (unsigned int)&__Core5_start);           /*The status returned by function call is ignored */
#endif
