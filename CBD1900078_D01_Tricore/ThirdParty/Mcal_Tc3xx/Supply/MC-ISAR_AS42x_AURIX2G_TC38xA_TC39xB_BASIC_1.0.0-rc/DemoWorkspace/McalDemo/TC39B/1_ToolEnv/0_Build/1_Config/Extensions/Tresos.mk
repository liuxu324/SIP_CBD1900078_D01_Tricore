...
BUILD_BASE_PATH=.
DEMOAPP_CONFIG_PATH=1_ToolEnv/2_Tresos/DemoApp/config
TRESOS_ROOT?=C:/sofit/aurix2g_sw_mcal/tresos/tresos
TRESOS_PROJECT_NAME?=DemoApp
TRESOS_BIN_PATH?=C:/sofit/aurix2g_sw_mcal/tresos/tresos/bin

TRESOS_GEN_BAT=$(TRESOS_BIN_PATH)/tresos_cmd.bat
TRESOS_WORKSPACE=1_ToolEnv/2_Tresos
...
ifeq ($(COMPILER),Tasking)
	...
	@cp ../../../Tools/Compiler_Configs/TC39B_FR2_Config_$(COMPILER).xml 1_ToolEnv/0_Build/1_Config/Config.xml
