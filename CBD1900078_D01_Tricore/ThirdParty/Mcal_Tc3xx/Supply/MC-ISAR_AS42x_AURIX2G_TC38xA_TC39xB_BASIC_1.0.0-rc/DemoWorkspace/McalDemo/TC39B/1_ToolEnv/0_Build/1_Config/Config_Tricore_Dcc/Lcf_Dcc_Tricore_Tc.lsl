...
MEMORY
{
    ...
    pfls0: org = 0x80000000 +32, len = 3M -32
...
/*Fixed memory Allocations for stack memory and CSA*/
    ...
    .startup (TEXT) BIND(0xA0000000) : { KEEP (*(.start)) .= 0xA0000020; } =0x800 > pfls0_nc
    ...
    .traptab_tc5 (TEXT) BIND(LCF_TRAPVEC5_START) : { __TRAPTAB_CPU5 = .; KEEP (*(.traptab_cpu5)) } > pfls5
    
    .startptr_tc0 (TEXT) BIND(LCF_STARTPTR_CPU0) : { __ENABLE_INDIVIDUAL_C_INIT_CPU0 = 0; __STARTPTR_CPU0 = .; KEEP (*(.startptr_cpu0)) } > pfls0
    .startptr_tc1 (TEXT) BIND(LCF_STARTPTR_CPU1) : { __ENABLE_INDIVIDUAL_C_INIT_CPU1 = 0; __STARTPTR_CPU1 = .; KEEP (*(.startptr_cpu1)) } > pfls1
    .startptr_tc2 (TEXT) BIND(LCF_STARTPTR_CPU2) : { __ENABLE_INDIVIDUAL_C_INIT_CPU2 = 0; __STARTPTR_CPU2 = .; KEEP (*(.startptr_cpu2)) } > pfls2
    .startptr_tc3 (TEXT) BIND(LCF_STARTPTR_CPU3) : { __ENABLE_INDIVIDUAL_C_INIT_CPU3 = 0; __STARTPTR_CPU3 = .; KEEP (*(.startptr_cpu3)) } > pfls3
    .startptr_tc4 (TEXT) BIND(LCF_STARTPTR_CPU4) : { __ENABLE_INDIVIDUAL_C_INIT_CPU4 = 0; __STARTPTR_CPU4 = .; KEEP (*(.startptr_cpu4)) } > pfls4
    .startptr_tc5 (TEXT) BIND(LCF_STARTPTR_CPU5) : { __ENABLE_INDIVIDUAL_C_INIT_CPU5 = 0; __STARTPTR_CPU5 = .; KEEP (*(.startptr_cpu5)) } > pfls5
    ...
    GROUP  : 
    {
        ...
        .zdata_powerOn (DATA) LOAD(> pfls0) COPYTABLE :
        {
...
/*Far Data / Far Const Sections, selectable with patterns and user defined sections*/
    ...
    GROUP :
    {
        .data (DATA) LOAD(> pfls0) COPYTABLE :
        {
            *(.data)
