...
B_TASKING_TRICORE_PATH?= C:\sofit\aurix2g_sw_mcal\tasking\ctc

B_TASKING_TRICORE_CC_OPTIONS= --core=tc1.6.2 --iso=99 -O2 --eabi-compliant -AGKpvX \
			--switch=auto --integer-enumeration --default-near-size=0 --fp-model=1

B_TASKING_TRICORE_LD_OPTIONS= --map-file -OcLtXY --core=mpe:vtc
