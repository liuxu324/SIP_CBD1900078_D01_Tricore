...
B_DCC_TRICORE_PATH?= C:\sofit\aurix2g_sw_mcal\windriver\compilers\diab-5.9.6.4\WIN32

B_DCC_TRICORE_CC_OPTIONS= -tTC162NF:simple -O -XO -Xsection-split=1 \
		-Xkeep-assembly-file=2 -g3 -Xinline=0 -Xdialect-c99 -ei5388,2273,5387 \
		-ei1824 -Xsmall-data=0 -Xsmall-const=0
