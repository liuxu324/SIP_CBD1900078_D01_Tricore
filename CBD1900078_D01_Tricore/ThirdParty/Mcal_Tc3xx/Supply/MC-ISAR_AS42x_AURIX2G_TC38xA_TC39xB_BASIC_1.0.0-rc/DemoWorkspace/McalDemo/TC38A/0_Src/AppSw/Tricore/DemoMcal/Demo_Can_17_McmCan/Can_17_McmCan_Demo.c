...
static void Can_EnableServiceRequest(uint8 node);                                                                                       
...
{                                                                                                                      
  ...
  Can_17_McmCan_SetControllerMode (Can_17_McmCanConf_CanController_CanController_1, CAN_T_STOP);      
	...
	for ( i = 0 ; i < Test_TxCount ; i++)
	{
		for ( j = 0; j < 8 ; j++)
		{
			if ( CanRxDataBuff[i][j] == PduInfo_1[i].sdu[j])
				continue;
			else
				TxRxDataMismatch = 1;
				break;
...
{                                                                                                                      
  ...
  Can_17_McmCan_SetControllerMode (Can_17_McmCanConf_CanController_CanController_1, CAN_T_STOP);            
	...
	for ( i = 0 ; i < Test_TxCount ; i++)
	{
		for ( j = 0; j < 8 ; j++)
		{
			if ( CanRxDataBuff[i][j] == PduInfo_ExtId[i].sdu[j])
				continue;
			else
				TxRxDataMismatch = 1;
				break;
...
{                                                                                                                      
  ...
  Can_17_McmCan_SetControllerMode (Can_17_McmCanConf_CanController_CanController_1, CAN_T_STOP);         
	...
	for ( i = 0 ; i < Test_TxCount ; i++)
	{
		for ( j = 0; j < 8 ; j++)
		{
			if ( CanRxDataBuff[i][j] == PduInfo_1_Mixed[i].sdu[j])
				continue;
			else
				TxRxDataMismatch = 1;
				break;
...
{                                                                                                                      
  ...
  Can_17_McmCan_SetControllerMode (Can_17_McmCanConf_CanController_CanController_1, CAN_T_STOP);   
	...
	for ( i = 0 ; i < Test_TxCount ; i++)
	{
		for ( j = 0; j < 8 ; j++)
		{
			if ( CanRxDataBuff[i][j] == PduInfo_TriggerTransmit[i].sdu[j])
				continue;
			else
				TxRxDataMismatch = 1;
				break;
...
{                                                                                                                      
  ...
  Can_17_McmCan_SetControllerMode (Can_17_McmCanConf_CanController_CanController_1, CAN_T_STOP);   
	...
	for ( i = 0 ; i < Test_TxCount ; i++)
	{
		for ( j = 0; j < 8 ; j++)
		{
			if ( CanRxDataBuff[i][j] == PduInfo_FD[i].sdu[j])
				continue;
			else
				TxRxDataMismatch = 1;
				break;
...
/*******************************************************************************                                       
** Syntax : static void Can_EnableServiceRequest(uint8 node)                  **                                       
**                                                                            **                                       
** Service ID:   : NA                                                         **                                       
**                                                                            **                                       
** Sync/Async:   : Synchronous                                                **                                       
