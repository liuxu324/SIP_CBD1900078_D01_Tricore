...
{                                                                                                                      
  ...
  {                                                                                                                    
    ...
    {                                                                                                                  
       ...
       case '3' :                                                                                                      
       {                                                                                                               
           Pwm_17_GtmCcu6_DemoDisableNotification();
           break;                                                                                                      
       }                                                                                                               
       case '4':                                                                                                       
       case 'X':                                                                                                       
...
{
  /* Change the pin mode to handle GTMCCU6 output signal */

  Port_SetPinMode(PortConf_PortContainer_19_PORT_33_PIN_7,PORT_PIN_MODE_ALT1);
  #if (PWM_NOTIFICATION_SUPPORTED == STD_ON)
  /* Enable PWM channel notifications */
  Pwm_17_GtmCcu6_EnableNotification(PwmChannel_0,PWM_BOTH_EDGES);
  #endif /* PWM_NOTIFICATION_SUPPORTED == STD_ON */
...
void Pwm_17_GtmCcu6_ChangeDutyDemo(void)
{
  ...
  Pwm_17_GtmCcu6_DisableNotification(PwmChannel_0);
  #endif
...
*******************************************************************************/
void Pwm_17_GtmCcu6_DemoDisableNotification(void)
{
    #if (PWM_SET_OUTPUT_TO_IDLE_API == STD_ON)
     Pwm_17_GtmCcu6_SetOutputToIdle(PwmChannel_0);
    #endif
  ...
  Port_SetPinMode(PortConf_PortContainer_19_PORT_33_PIN_7,PORT_PIN_MODE_GPIO);
        StartResult();
        print_f("Result = Pass;");
        EndResult();
