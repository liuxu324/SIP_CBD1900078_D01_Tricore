...
#if ( CAN_17_MCMCAN_SW_MAJOR_VERSION != 4U )
...
#define CAN_17_MCMCAN_CLEAR_IE_RF1W_BIT                 (uint32) (0x00000020U)

/* Clear RF1W (Rx FIFO 0 Watermark Reached) flag in IR register */
#define CAN_17_MCMCAN_CLEAR_IE_RF0W_BIT                 (uint32) (0x00000002U)
#endif /* #if(CAN_17_MCMCAN_RX_INTERRUPT_PROCESSING == STD_ON) */
...
static Std_ReturnType Can_17_McmCan_lTimeOut ( \
  ...
  (CAN_17_MCMCAN_PUBLIC_ICOM_SUPPORT == STD_ON))|| \
  (CAN_17_MCMCAN_BO_POLLING_PROCESSING == STD_ON)|| \
  (CAN_17_MCMCAN_RX_POLLING_PROCESSING == STD_ON)|| \
  (CAN_17_MCMCAN_TX_POLLING_PROCESSING == STD_ON))
...
without safegaurd. It complies to Autosar guidelines. */
#include "Can_17_McmCan_MemMap.h"
/* [cover parentID={1EF28616-1D93-4760-B9AB-5D9A34806B1C}]
[/cover] */
...
**                    [cover parentID={196A1432-EAB1-461a-BD6C-259784BF6397}] **
**                                                                            **
...
/* [cover parentID={832137E8-E200-46db-94F9-DA2575D59A18}]
  ...
  /* [cover parentID={CEB9BCDB-B4D6-4bbb-A342-B47322AC2373}]
  Merge
  [/cover] */
...
/*******************************************************************************
            Scheduled functions
*******************************************************************************/
/* [cover parentID={809BFB2C-E302-45b1-8B4A-881B00FC5C7E}]
[/cover] */
...
/* [cover parentID={A2266E18-95A8-4ad5-9E3D-670D9F3BB95F}]
[/cover] */
...
{
/* [cover parentID={A74C3ECF-0359-4bc0-A66E-095DB8FF4570}]
  ...
  if(E_OK == ApiStatus)
  {
        ...
        CtrlIndex++)
    {
        ...
        && (CANIF_CS_STARTED == CanCoreState->CanControllerModePtr[CtrlIndex]))
        {
          ...
          [/cover] */
          /* Invoke internal function to process recieve confirmation */
                ...
                const Can_17_McmCan_CoreConfigType* const CanConfig)
{
  ...
  /* [cover parentID={1691C839-6EFD-4be0-A0A0-37513FAA4220}]
    Tx Event buffer is allocated or not
    [/cover] */
...
/*CYCLOMATIC_Can_17_McmCan_lWriteMsgObj_JUSTIFICATION: This Function has
cyclomatic Complexity of 16 if breaking it into two functions will impact the
                    ...
                    const Can_17_McmCan_CoreConfigType* const CanConfig)
{
  ...
  if(CAN_17_MCMCAN_DATA_ZERO != (NodeRegAddressPtr->TX.BRP.U & BuffIndex))
  {
  ...
  [/cover] */
  /* [cover parentID={D6BD0187-F5E2-4475-8B50-B8E1FE595217}]
  CAN_17_MCMCAN_MULTIPLEXED_TRANSMISSION is enabled
  [/cover] */
  else
  {
  ...
  [/cover] */
  if(TRUE == CanCoreState->CanIcomEnableStatusPtr[ControllerId])
  {
    /* [cover parentID={65F98883-86B6-4258-A828-57110E43C470}]
    Return BUSY
    [/cover] */
  ...
  RetVal = Can_17_McmCan_lUpdatePduInfo(HthIndex,TempPduInfo,PduInfo,CanConfig);
  if(CAN_OK != RetVal)
  {
    ApiStatus =  CAN_NOT_OK;
  }
  ...
  if(CAN_OK == ApiStatus)
  {
    /* [cover parentID={3795DCA6-43ED-407b-9DF3-D0624631B262}]
    Enter Critical Section call
    [/cover] */
    /* [cover parentID={6E1CBB09-0089-421f-AFD2-C08A9E6EAEB6}]
    Enter Critical Section
  ...
  const Can_17_McmCan_CoreConfigType* const CanConfig)
{
    ...
    (CheckBuffType == CAN_17_MCMCAN_ZERO))
  {
    ...
    /* [cover parentID={6B2EFACA-75BB-44e0-A0A2-7BE1D2A73CB5}]
      Check Received CAN message is lost or not
      [/cover] */
    if(CAN_17_MCMCAN_BIT_CLEAR_VAL != NodeRegAddressPtr->RX.F0S.B.RF0L)
    {
      #if(CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON)
      ...
      Det error CAN_17_MCMCAN_E_DATALOST
      [/cover] */
      /* Report to DET */
      Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID, \
        CAN_17_MCMCAN_SID_RECEIVEHANDLER, CAN_17_MCMCAN_E_DATALOST);
      #endif
      NodeRegAddressPtr->IR.B.RF0L = CAN_17_MCMCAN_ONE;
    }
    ...
    while(LoopExitFlag < RxFillLvlVal)
    {
      ...
      LoopExitFlag++;
      /* Clear Fifo full flag after the read is done */
      NodeRegAddressPtr->IR.B.RF0F = CAN_17_MCMCAN_ONE;
    }
  }
    ...
    (CheckBuffType == CAN_17_MCMCAN_ZERO))
  {
    ...
    /* [cover parentID={AE3A81FA-3AA2-4049-A631-C6031F38A6F6}]
      Check Received CAN message is lost or not
      [/cover] */
    if(CAN_17_MCMCAN_BIT_CLEAR_VAL != NodeRegAddressPtr->RX.F1S.B.RF1L)
    {
      #if(CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON)
      ...
      Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID, \
        CAN_17_MCMCAN_SID_RECEIVEHANDLER, CAN_17_MCMCAN_E_DATALOST);
      #endif
      NodeRegAddressPtr->IR.B.RF1L = CAN_17_MCMCAN_ONE;
    }
    /* Set safety loop exit flag with value zero */
    LoopExitFlag = CAN_17_MCMCAN_ZERO;
    /* Read Fill Level value */
    ...
    while(LoopExitFlag < RxFillLvlVal)
    {
      ...
      LoopExitFlag++;
      /* Clear Fifo full flag after the read is done */
      NodeRegAddressPtr->IR.B.RF1F = CAN_17_MCMCAN_ONE;
    }
  }
}
#endif /* #if(((CAN_17_MCMCAN_RX_POLLING_PROCESSING == STD_ON)&& \
                ...
                const Can_17_McmCan_CoreConfigType* const CanConfig)
{
    ...
    (CAN_17_MCMCAN_NOOF_TX_HW_BUFF_AVAILABLE > LoopExitFlag))
  {
    ...
    /*[cover parentID={CF5C13A2-E51C-4f13-8152-B8B4591F3FFF}]
     ...
     [/cover]*/
    CanIf_TxConfirmation(CanCoreState->CanSwObjectHandlePtr[SwObjIndx]);
  ...
  if(E_NOT_OK != ApiStatus)
  {
      ...
      CtrlIndex++)
    {
       ...
       && (CANIF_CS_STARTED == CanCoreState->CanControllerModePtr[CtrlIndex]))
      {
        ...
        {
          /* retrive the Sw object hanle for the current priority */
          ...
          check if priority state is filled with valid sw handle
          [/cover] */
          ...
          else
          {
            ...
            if(E_OK == SwObjFound)
            {
              ...
              update Sw handle priority list
              [/cover] */
...
cyclomatic Complexity of 18 which is handling Rx mainfunction periods.
*/
/*******************************************************************************
**                                                                            **
  ...
  const Can_17_McmCan_CoreConfigType* const CanConfig)
{
  ...
  NodeRegAddressPtr->CCCR.B.CCE = CAN_17_MCMCAN_ZERO;
    ...
    const uint8 CoreIndex)
{
  ...
  if (NULL_PTR == Config)
  {
   ...
   /* [cover parentID={3AD9D42B-9ED6-4809-A008-0599C92C82F0}]
    [/cover] */
  #if (CAN_17_MCMCAN_MULTICORE_ERROR_DETECT == STD_ON)
...
**                    [cover parentID={D47A49B6-985A-4c4f-86D5-C17125DAE268}] **
**                                                                            **
                                        ...
                                        const uint8 NodeIdIndex)
{
        ...
        CanEventHandlingConfigPtr[CntrlIndx].CanEventType[CAN_17_MCMCAN_ZERO])
  {
    ...
    NodeRegAddressPtr = \
          ...
          /* [cover parentID={EF1E9B31-4032-4682-BD50-B7C6EC3B8CB5}]
    Check if Tx Event FIFO New Entry is stored
    [/cover] */
    /* Check if Tx Event FIFO New Entry is stored */
    if(CAN_17_MCMCAN_BIT_SET_VAL == NodeRegAddressPtr->IR.B.TEFN)
    {
/* [cover parentID={37BEC4E9-A8B9-46eb-959D-5A093D039C26}]
    Check if config pointer is NULL_PTR
    [/cover] */
      if(NULL_PTR != CanConfig->CanTxHwObjectConfigPtr)
      {
      ...
      /* [cover parentID={C3B17DCE-E7F1-4984-811F-744B914FA7C3}]
      [cover parentID={D0F08DBA-DBE3-4441-9EA9-52407DEDD02E}]
      Reset flag for next RxEvent Entry
      [/cover] */
      /* Reset flag for next TxEvent Entry */
      NodeRegAddressPtr->IR.U = CAN_17_MCMCAN_CLEAR_IE_TEFN_BIT;
    }
  }
  /* [cover parentID={F75BF717-BD29-42cf-B0CA-F37F8FBA550D}]
  [/cover] */
}
#endif /* #if(CAN_17_MCMCAN_TX_INTERRUPT_PROCESSING == STD_ON) */
                                      ...
                                      const uint8 NodeIdIndex)
{
      ...
      CanEventType[CAN_17_MCMCAN_ONE])
  {
    ...
    /*[cover parentID={BB724744-3D24-49cd-B61C-1081F49E4FED}]
      Check if any of the Message stored to Dedicated Rx Buffer
      [/cover] */
    if(CAN_17_MCMCAN_BIT_SET_VAL == NodeRegAddressPtr->IR.B.DRX)
    {
  ...
  /* [cover parentID={072E300A-20F6-49a4-A2E0-78FF0BF320BD}]
  [/cover] */
  /* [cover parentID={B9BEDA0A-3510-428d-ADD3-371A5DAF6F46}]
  [/cover] */
}
#endif /* #if(CAN_17_MCMCAN_RX_INTERRUPT_PROCESSING == STD_ON) */
                                       ...
                                       const uint8 NodeIdIndex)
{
        ...
        CanEventType[CAN_17_MCMCAN_ONE])
  {
    ...
    /*[cover parentID= {F09D073D-1AA6-4b42-83F0-7C91C64B08C8}]
      Check if any of the New message written to Rx FIFO 0
      [/cover] */
    if(CAN_17_MCMCAN_BIT_SET_VAL == NodeRegAddressPtr->IR.B.RF0W)
    {
      ...
      NodeRegAddressPtr->IR.U = CAN_17_MCMCAN_CLEAR_IE_RF0W_BIT;
    }
    /* Check if any of the New message written to Rx FIFO 1 */
    /*[cover parentID= {CDC83D92-70B2-41ac-AF14-868EA78E3632}]
      Check if any of the New message written to Rx FIFO 1
      [/cover] */
    if(CAN_17_MCMCAN_BIT_SET_VAL == NodeRegAddressPtr->IR.B.RF1W)
    {
      ...
      /*[cover parentID=  {64C5383C-F8D0-4e31-A430-9F4BE8D20605}]
      [/cover] */
      /* Reset flag for New message to RXFIFO1 */

      NodeRegAddressPtr->IR.U = CAN_17_MCMCAN_CLEAR_IE_RF1W_BIT;
    }
  }
  /* [cover parentID={B80FE56D-D749-454d-AA35-DADAC2AC75F8}]
  [/cover] */
}
#endif /* #if(CAN_17_MCMCAN_RX_INTERRUPT_PROCESSING == STD_ON) */
       ...
       CanEventType[CAN_17_MCMCAN_TWO])
  {
    ...
    if( CAN_17_MCMCAN_BIT_SET_VAL == NodeRegAddressPtr->IR.B.BO)
    {
         ...
         (FALSE != CanCoreState->CanIcomConfgBOStatusPtr[CntrlIndx]))
      {
        ...
        /* [cover parentID={4FE04C6B-A812-4cbd-A335-628767BC288D}]
        [/cover] */
        /* [cover parentID={64006E0F-D702-4ca2-BC41-C5011F6A4713}]
        [/cover] */
        /* Reset BO flag */
