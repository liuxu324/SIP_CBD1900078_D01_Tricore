...
/*Invalid parameter*/
#define FLS_17_DMU_E_PARAM_INVLD            ((uint8)90)
/*Initialization failed in Init*/
#define FLS_17_DMU_E_INIT_FAILED            ((uint8)95)
/*Suspend Operation not allowed*/
#define FLS_17_DMU_E_ILLGL_OPERTN           ((uint8)100)
/*HW Busy*/
#define FLS_17_DMU_E_HW_BUSY           ((uint8)110)
/*Timeout after the command is executed*/
#define FLS_17_DMU_E_HW_TIMEOUT         ((uint8)115)
/*Suspend Erase Error*/
#define FLS_17_DMU_E_SUSPNDERASE_FAIL      ((uint8)80)
/*Invalid Interrupt*/
#define FLS_17_DMU_E_INVALID_ISR            ((uint8)120)
...
#define FLS_17_DMU_HARDENCHK_NOTREQD       ((uint8)0)
#define FLS_17_DMU_HARDENCHK_REQRD         ((uint8)1)
#define FLS_17_DMU_HARDENCHK_ERROR         ((uint8)2)
/*Hardening Align Check*/
#define FLS_17_DMU_PAGE_HARDEN           ((uint8)(0x55))
#define FLS_17_DMU_WORDSIZE_HARDEN       ((uint8)(0xAA))
#endif
...
/*******************************************************************************
** Syntax : Std_ReturnType Fls_17_Dmu_Compare( Fls_AddressType SourceAddress, **
...
/*******************************************************************************
** Syntax : MemIf_StatusType Fls_17_Dmu_GetBankStatus(uint32 BankNum)         **
**                                                                            **
** Service ID:  0x27                                                          **
**                                                                            **
** Sync/Async:  Synchronous                                                   **
...
**         This service shall return the driver state synchronously           **
*******************************************************************************/
extern MemIf_StatusType Fls_17_Dmu_GetBankStatus(uint32 BankNum);
...
/* MISRA2012_RULE_4_9_JUSTIFICATION: Error generation when API is called 
without configuring it  */
#define Fls_17_Dmu_GetBankStatus() \
(ERROR_FlsGetStatusApi_NOT_SELECTED)
...
/* MISRA2012_RULE_4_9_JUSTIFICATION: Error generation when API is called 
without configuring it  */
#define Fls_17_Dmu_VerifyErase(BankNum,UnerasedWLAddrPtr,UnerasedWLCountPtr) \
(ERROR_IFX_FEE_NOT_CONFIGURED)

/* MISRA2012_RULE_4_9_JUSTIFICATION: Error generation when API is called 
without configuring it  */
#define Fls_17_Dmu_VerifySectorErase(BankNum,UnerasedWLAddrPtr, \
...
/* MISRA2012_RULE_4_9_JUSTIFICATION: Error generation when API is called 
without configuring it  */
#define Fls_17_Dmu_SuspendErase(BankNum) \
(ERROR_FlsUseEraseSuspend_NOT_SELECTED)

/* MISRA2012_RULE_4_9_JUSTIFICATION: Error generation when API is called 
without configuring it  */
#define Fls_17_Dmu_ResumeErase(BankNum) \
(ERROR_FlsUseEraseSuspend_NOT_SELECTED)
...
/*******************************************************************************
** Syntax : boolean Fls_17_Dmu_IsHardeningRequired(Fls_17_Dmu_AddressType     **
**                                                          TargetAddress)    **
**                                                                            **
** Service ID: 0x2C                                                           **
**                                                                            **
...
**                                                                            **
*******************************************************************************/
Std_ReturnType Fls_17_Dmu_InitCheck(
                             const Fls_17_Dmu_ConfigType *const ConfigPtr);
/******************************************************************************/
#else
...
/* MISRA2012_RULE_5_5_JUSTIFICATION:Memmap macros are defined as per Autosar
naming convention, hence it goes beyond 32 characters.*/
#define Fls_InitCheck(void) (ERROR_FlsInitCheck_NOT_SELECTED)
#endif
